...
from .gt_model import GEARS_GT_Model
...
class GEARS_GT(GEARS):
    """
    GEARS with graph transformers in place of GNNs
    """
    ...
    def __init__(self, pert_data, 
        ...
        super(GEARS_GT, self).__init__(pert_data, device, weight_bias_track, proj_name, exp_name)
    ...
    def tunable_parameters(self):
        ...
        return {'hidden_size': 'hidden dimension, default 64',
                ...
                'num_go_gt_layers': 'number of GT layers for GO graph, default 1',
                'num_gene_gt_layers': 'number of GT layers for co-expression gene graph, default 1',
    ...
    def model_initialize(self, hidden_size = 64,
        ...
        num_go_gt_layers: int
            number of GT layers for GO graph, default 1
        num_gene_gt_layers: int
            number of GT layers for co-expression gene graph, default 1
        decoder_hidden_size: int
            hidden dimension for gene-specific decoder, default 16
        num_attention_heads: int
            number of attention heads for the GT, default 1
        ...
        self.config = {'hidden_size': hidden_size,
                       ...
                       'num_go_gt_layers' : num_go_gt_layers, 
                       'num_gene_gt_layers' : num_gene_gt_layers,
        ...
        self.model = GEARS_GT_Model(self.config).to(self.device)
